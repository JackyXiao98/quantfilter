...
try:
    ...
    from .data_collator import DataCollatorForData2TextLanguageModeling
    from .language_modeling import LineByLineE2ETextDataset, LineByLineTriplesTextDataset
except:
    from E2E_utils.compiled_args import DataTrainingArguments
    from E2E_utils.data_collator import DataCollatorForData2TextLanguageModeling
    from E2E_utils.language_modeling import LineByLineE2ETextDataset, LineByLineTriplesTextDataset
