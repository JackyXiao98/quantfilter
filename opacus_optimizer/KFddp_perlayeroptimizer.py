...
from opacus.optimizers.ddp_perlayeroptimizer import _clip_and_accumulate_parameter,_generate_noise
...
class KF_SimpleDistributedPerLayerOptimizer(KF_DPPerLayerOptimizer, KF_DistributedDPOptimizer):
    def __init__(
        self,
        optimizer: Optimizer,
        *,
